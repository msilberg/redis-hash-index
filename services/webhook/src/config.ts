...
// Max keys per multi-key command (UNLINK). Matches packages/cache's default so both paths batch
// the same way and neither is flattered by a different batch size.
